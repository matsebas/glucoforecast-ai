...
import { Activity, Clock, TrendingDown, TrendingUp, AlertTriangle, RefreshCw, Bot } from "lucide-react"
    ...
    try {
      ...
      if (result.readings && result.readings.length > 0) {
        ...
        setData({
          ...
          timeInRange: result.metrics.timeInRange.inRange,
          timeAboveRange: result.metrics.timeInRange.above,
          timeBelowRange: result.metrics.timeInRange.below,
          ...
          <CardContent className="py-6">
            <div className="text-center">
              ...
              <p className="text-muted-foreground mt-2">
                Sube un archivo CSV con tus datos o configura la conexión con FreeStyle Libre para comenzar.
              </p>
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">Variabilidad: {data.glucoseVariability}%</p>
              </CardContent>
            </Card>
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <div className="grid gap-4 md:grid-cols-3">
                ...
                <TabsContent value="analysis" className="space-y-4">
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>Análisis generado por IA de tus datos de glucosa</CardDescription>
                    </CardHeader>
                    <CardContent>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="rounded-lg border p-4 bg-muted">
                  <p className="text-sm">"¿Qué significa un tiempo en rango del {data.timeInRange}%?"</p>
                </div>
                <div className="rounded-lg border p-4 bg-muted">
