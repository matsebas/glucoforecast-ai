import { Wifi, Database, WifiOff, ServerOffIcon as DatabaseOff } from "lucide-react"
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <div className="flex items-center gap-1 rounded-full bg-muted px-2 py-1">
              ...
              <span className="text-xs font-medium">{hasData ? "Datos disponibles" : "Sin datos"}</span>
            </div>
          </TooltipTrigger>
          <TooltipContent>
